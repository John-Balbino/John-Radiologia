    ...
    <section id="Sobre" className=" my-20 text-center text-lg ">
      <div className="flex gap-10 items-center justify-center flex-col md:flex-row">
        <article className="flex-col">
          <h2 className="text-[18px] md:text-3xl bg-linear-to-r from-blue-600 via-blue-400 to-purple-300  bg-clip-text text-transparent">
            Seja bem-vindo(a) ao nosso site
          </h2>
          <p className="w-fit p-10 md:w-80 lg:w-100 mx-auto mt-5 text-justify">
